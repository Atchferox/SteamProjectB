...
def get_friends(steamid: int):
	...
	name_steamid = {player["personaname"]: player["steamid"] for player in userdata["response"]["players"]}  #Dict comprehension to get names and idd of friends
	names = list(name_steamid.keys()) #Create list of names
